...
\begin{description}
    ...
    \item[Total througput] was captured by Memaslap, the Memcached benchmarking tool. Throughput is measured in operations per second.
\end{description}
...
\begin{figure}[p]
    ...
    \caption{Throughput for original Rafter and different structured voting schemes (legend as for \cref{fig:ttc}). The dashed lines indicate the second order polynomial best fit.}
