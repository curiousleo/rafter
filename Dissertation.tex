...
Unfortunately, I was unable to simulate failures in this way on Amazon \ECC. Thus only local failure simulation measurements could be obtained (see \cref{fig:failure-ttc}).
...
In this chapter, I first compare my achievements with the requirements in the original project proposal. This is followed by a description of my unit test rig. The rest of the chapter specifies the benchmarking set-up and discusses the results.
