...
\pagenumbering{roman} % or scrbook + \frontmatter
...
\pagenumbering{arabic} % or scrbook + \mainmatter before \chapter
...
\section{\textsc{cap}, \textsc{acid} and \textsc{base}\label{sc:cap-acid-and-base}}
